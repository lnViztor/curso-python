...
parser = argparse.ArgumentParser(
    description="Web scraping to check SEO for a given URL")
parser.add_argument(
    'url', type=str, help='The URL of the site you want to scrape and check')
...
if response.status_code == 200:
    ...
    if titulo_pagina:
        ...
        if len(titulo_pagina) < 70:
            print(
                "\033[32m✅  El título de la página tiene una longitud adecuada\033[0m")
        else:
